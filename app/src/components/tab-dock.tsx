...
export function TabDock() {
  ...
  return (
    <nav
      className="fixed bottom-3 left-1/2 z-50 flex w-[calc(100%-1.5rem)] max-w-md -translate-x-1/2 items-center justify-between gap-1 rounded-[32px] border border-edge-soft bg-[#103324CC] px-2 py-2 shadow-[0_18px_50px_rgba(0,0,0,0.55)] backdrop-blur-xl md:hidden"
      aria-label="primary"
    >
      {tabs.map((t) => {
